	...
	return (
		<div className="max-sm:has-[div[role=&quot;toolbar&quot;]]:mb-16 flex flex-1 flex-col gap-4">
			...
			<div className="flex items-center justify-between">
				<Input
					placeholder="Filter transaction no..."
					value={(table.getColumn("transaction_no")?.getFilterValue() as string) ?? ""}
					onChange={(event) =>
						table.getColumn("transaction_no")?.setFilterValue(event.target.value)
					}
					className="max-w-sm"
				/>
				<DropdownMenu>
